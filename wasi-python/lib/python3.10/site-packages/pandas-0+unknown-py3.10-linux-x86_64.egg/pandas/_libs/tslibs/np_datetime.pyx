...
cdef extern from "src/datetime/np_datetime.h":
    ...
    PyArray_DatetimeMetaData pandas_get_datetime_metadata_from_dtype(cnp.PyArray_Descr *dtype);

cdef extern from "src/datetime/np_datetime_strings.h":
    int pandas_parse_iso_8601_datetime(const char *str, int len, int want_exc,
...
cdef NPY_DATETIMEUNIT get_unit_from_dtype(cnp.dtype dtype):
    ...
    meta = pandas_get_datetime_metadata_from_dtype(descr)
    return meta.base
...
cdef inline int string_to_dts(
    ...
    return pandas_parse_iso_8601_datetime(buf, length, want_exc,
